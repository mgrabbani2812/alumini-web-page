...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Sep 2023 07:33:00 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="utf-8" />
                            ...
                            <div class="upcoming-event-content owl-carousel">
                                            ...
                                            <div class="display-table">
                                                <div class="display-table-cell">
                                                    <div class="up-event-text">
                                                        ...
                                                        <h3><a href="single-event.php">We are going to arrange a get
                                                                together!</a></h3>
                                                        ...
                                                        <a href="single-event.php" class="btn btn-brand btn-brand-dark">join
                                                            with us</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="single-upcoming-event">
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="up-event-thumb">
                                                <img src="assets/images/event/event-img-2.jpg" class="img-fluid" alt="Upcoming Event">
                                                <h4 class="up-event-date">It’s 27 February 2023</h4>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-10">
                            <div class="about-content-wrap">
                                ...
                                <div class="about-thumb">
                                    <img src="assets/images/misc/about-bg.jpg" alt="" class="img-fluid">
                                </div>
                ...
                <div class="row text-center text-sm-left">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-responsibility">
                            <img src="assets/images/responsibility/01.png" alt="Responsibility">
                            <h4>Scholarship</h4>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-responsibility">
                            <img src="assets/images/responsibility/02.png" alt="Responsibility">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-responsibility">
                            <img src="assets/images/responsibility/03.png" alt="Responsibility">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-responsibility">
                            <img src="assets/images/responsibility/04.png" alt="Responsibility">
        ...
        <section id="job-opportunity" class="section-padding">
            <div class="container">
                ...
                <div class="job-opportunity-wrapper">
                            ...
                            <div class="single-job-opportunity">
                                <div class="job-opportunity-text">
                                    <div class="job-oppor-logo">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                                                <img src="assets/images/job/compnay-logo-1.png" alt="Job">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="single-job-opportunity">
                                <div class="job-opportunity-text">
                                    <div class="job-oppor-logo">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                                                <img src="assets/images/job/compnay-logo-2.png" alt="Job">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="single-job-opportunity">
                                <div class="job-opportunity-text">
                                    <div class="job-oppor-logo">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                                                <img src="assets/images/job/compnay-logo-3.png" alt="Job">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="single-job-opportunity">
                                <div class="job-opportunity-text">
                                    <div class="job-oppor-logo">
                                        <div class="display-table">
                                            <div class="display-table-cell">
                                                <img src="assets/images/job/compnay-logo-4.png" alt="Job">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <a href="career.php" class="btn btn-brand btn-loadmore">All job list</a>
                        </div>
                    </div>
                </div>
                <!--== Job opportunity Wrapper ==-->
                                ...
                                <div class="col-lg-3  col-sm-6 recent event">
                                    <div class="single-gallery-item gallery-bg-1">
                                        <div class="gallery-hvr-wrap">
                                            ...
                                            <a href="assets/images/gallery/gellary-img-1.jpg" class="btn-zoom image-popup">
                                ...
                                <div class="col-lg-3  col-sm-6 recent pic">
                                    <div class="single-gallery-item gallery-bg-3">
                                        <div class="gallery-hvr-wrap">
                                            ...
                                            <a href="assets/images/gallery/gellary-img-3.jpg" class="btn-zoom image-popup">
                                                <img src="assets/images/zoom-icon.png" alt="a">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3  col-sm-6 old">
                                    <div class="single-gallery-item gallery-bg-4">
                                        <div class="gallery-hvr-wrap">
                                            ...
                                            <a href="assets/images/gallery/gellary-img-4.jpg" class="btn-zoom image-popup">
                                                <img src="assets/images/zoom-icon.png" alt="a">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3  col-sm-6 pic event">
                                    <div class="single-gallery-item gallery-bg-5">
                                        <div class="gallery-hvr-wrap">
                                            ...
                                            <a href="assets/images/gallery/gellary-img-5.jpg" class="btn-zoom image-popup">
                                                <img src="assets/images/zoom-icon.png" alt="a">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3  col-sm-6 old recent">
                                    <div class="single-gallery-item gallery-bg-6">
                                        <div class="gallery-hvr-wrap">
                                            ...
                                            <a href="assets/images/gallery/gellary-img-6.jpg" class="btn-zoom image-popup">
                                                <img src="assets/images/zoom-icon.png" alt="a">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3  col-sm-6 pic recent old">
                                    <div class="single-gallery-item gallery-bg-8">
                                        <div class="gallery-hvr-wrap">
                                            ...
                                            <a href="assets/images/gallery/gellary-img-8.jpg" class="btn-zoom image-popup">
                                                <img src="assets/images/zoom-icon.png" alt="a">
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <article class="single-blog-post">
                            ...
                            <div class="blog-content">
                                <h3><a href="single-blog.php">Recently we create a maassive project that</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <article class="single-blog-post">
                            ...
                            <div class="blog-content">
                                <h3><a href="single-blog.php">Myra Hindley and her lover, Ian Brady, plotted and</a></h3>
                                <p>This is a big project of our company, we are happy to completed this type projec which are
                                    get world famous award</p>
                                <a href="single-blog.php" class="btn btn-brand">More</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <article class="single-blog-post">
                            ...
                            <div class="blog-content">
                                <h3><a href="single-blog.php">Nurse with a private practice, racked up dozens of victims</a>
                                </h3>
                                <p>This is a big project of our company, we are happy to completed this type projec which are
                                    get world famous award</p>
                                <a href="single-blog.php" class="btn btn-brand">More</a>
