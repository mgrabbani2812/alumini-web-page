...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/single-event.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Sep 2023 07:33:11 GMT -->
<head>
    <!-- Meta Data -->
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title> Event Details - University Alumni Html Template</title>
...
<body id="event-v1" class="event-details-page" data-style="default">
                            ...
                            <div class="single-event-details">
                                <div class="event-thumbnails">
                                    ...
                                    <div class="event-countdown">
                                        <div class="event-countdown-counter" data-date="2024/10/10"></div>
                                        <p>Remaining</p>
                                    </div>
                                </div>
                                ...
                                <p>
                                    ...
                                    tempus non, auctor endrerit quis, nisi..
                                </p>

                                <p>
                                    Etiam rhoncus. Ut leo. Morbi mollis tellus ac sapien. Fusce fermentum oo nec arcu. Quisque
                                    malesuada placerat nisl. Etiam sit amet orci eget faucitincidunt. Quisque rutrum.
                                    Pellentesque posuere. Praesent ac massa at ligula laoureet iaculis. Cras risus ipsum,
                                    faucibus ut, ullamcorper id, varius ac, leo.Ut a nisl id
                                    ...
                                    aliquet nec, vulputate eget, arcu. In turpis. Quisque id mi.
                                </p>
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#cbx-event-accordion">
                                                        <div class="accordion-body">
                                                            ...
                                                            <h4 class="speaker-name"><strong>Speaker:</strong> Adam Watshon,
                                                                <span class="speaker-deg">Crish Joshef</span>
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingTwo">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                            <span class="event-time">11am - 2pm</span> Grand Opening Speech of
                                                            Our Event And Re Introductory episode
                                                        </button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingThree">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                            <span class="event-time">2am - 5pm</span> Grand Opening Speech of
                                                            Our Event And Re Introductory episode
                                                        </button>
                                                    </h2>
